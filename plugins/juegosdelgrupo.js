...
try {
let vn = './media/ja.mp3'
let pp = 'https://i.imgur.com/CiGAfPY.jpeg'
...
└────ׂ─ׂ─ׂ─ׂ───
`.trim()
conn.sendHydrated(m.chat, str, wm, pp, 'https://github.com/vicente2001-admin/DANKIE-BOT', '𝙶𝙸𝚃𝙷𝚄𝙱', null, null, [
['𝐌𝐄𝐍𝐔', '/menu'],
['𝐄𝐒𝐓𝐀𝐃𝐎','/estado'],
